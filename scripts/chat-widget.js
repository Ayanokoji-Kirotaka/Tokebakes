    ...
    style.textContent = `
      ...
      .tb-chat-widget-button {
        ...
        background:
          ...
          linear-gradient(145deg, #33de78, #12b95a 68%, #0e9548);
        color: #fff;
      ...
      .tb-chat-widget-avatar {
        ...
        box-shadow: 0 10px 18px rgba(18, 45, 24, 0.12);
      }
      ...
      .tb-chat-widget-send {
        ...
        font-size: 0.84rem;
        font-weight: 700;
        background: linear-gradient(135deg, #25d366, #13b85b);
        color: #fff;
        cursor: pointer;
        box-shadow: 0 12px 22px rgba(17, 180, 83, 0.24);
      }
    ...
    root.innerHTML = `
      ...
      <div class="tb-chat-widget-panel" role="dialog" aria-modal="false" aria-label="Chat with ${toSafeString(
        ...
        <header class="tb-chat-widget-head">
          ...
          <button type="button" class="tb-chat-widget-close" aria-label="Close chat">&times;</button>
        </header>
